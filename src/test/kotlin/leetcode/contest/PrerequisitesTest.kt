...
internal class PrerequisitesTest {
    ...
    fun checkIfPrerequisite() {
        ...
        assertArrayEquals(
            ...
            cp.checkIfPrerequisite(2, arrayOf(intArrayOf(1, 0)), arrayOf(intArrayOf(0, 1), intArrayOf(1, 0)))
        )
        assertArrayEquals(
            booleanArrayOf(false, false),
            cp.checkIfPrerequisite(2, arrayOf(), arrayOf(intArrayOf(0, 1), intArrayOf(1, 0)))
        )
        assertArrayEquals(
